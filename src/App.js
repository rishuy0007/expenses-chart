...
function App() {
  ...
  return (
    ...
    <div className="max-w-xl mx-auto flex flex-col justify-center h-screen ">
      <article className="soft-red p-8 rounded-2xl  shadow text-white flex items-center justify-between">
      ...
      <article className="pt-8 border-t border-slate-200 flex justify-between">
        <h2 className="font-bold text-4xl">
        <span  className=" block text-base font-normal opacity-75 ">Total this month</span>$478.33 
        </h2>
       
      <h3 className="flex items-end justify-end flex-col text-base font-bold ">
      +2.4%
      <span className="block font-normal opacity-75">from last month</span>
